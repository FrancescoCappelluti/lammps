...
FRESP stands for Fluctuating-ReStrained Electrostatic Potential. 
This package provides methods for performing fluctuating charges 
simulations by using a :doc:`fix_fresp <fix_fresp>` command.

**Author:** Francesco Cappelluti (L'Aquila University)

**Supporting info:**

* src/USER-FRESP: filenames -> commands
* src/USER-FRESP/README
* :doc `fix fresp <fix_fresp>`
* examples/USER/fresp
